...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent::agent_archive_session,
            commands::agent::agent_set_session_skills,
            ...
            commands::chat::chat_message_tag,
            ...
            commands::git_host::git_push_branch,
            commands::git_host::git_host_token_status,
            commands::git_host::git_host_set_token,
            commands::git_host::pr_create,
