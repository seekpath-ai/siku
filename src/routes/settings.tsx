...
import { SettingsLayout, GeneralIcon, LlmIcon, AgentIcon, PetIcon, AdvancedIcon, SyncIcon, SearchIcon } from '@/components/settings/SettingsLayout';
  ...
  return (
    <SettingsLayout
      sections={[
        ...
        { key: 'search', label: '网络搜索', icon: <SearchIcon />, component: <SearchSettings /> },
